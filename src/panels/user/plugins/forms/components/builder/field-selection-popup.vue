...
const availableFieldTypes = computed(() => {
    // If not adding to a container, all field types are available (except guest repeater if already exists)
...
function getFieldDescription(type) {
    const descriptions = {
        ...
        'system_contact_guests': 'Allow users to add guest information'
    };
